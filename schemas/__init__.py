from .API_schemas import APIResponseSchema
from .users_schema import UserSchema, UserPublic
from .players_schema import PlayersSchema, PlayersInMatchSchema
from .games_schema import GameSchema, GameRoomSchema, MoveSchema, RetryCardsSchema, RoomSchema
...
class APIResponseProps:
    def __init__(
        ...
        # self.player_in_match_data: PlayersInMatchSchema = None
